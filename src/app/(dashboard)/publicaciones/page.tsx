                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
                    ...
                    <div className="flex items-center gap-3 flex-wrap justify-end">
                        ...
                        <button 
                            ...
                            className="bg-indigo-600 hover:bg-indigo-500 disabled:bg-gray-600 disabled:opacity-50 text-white px-4 py-1.5 rounded-lg font-bold text-sm shadow-md transition flex items-center gap-2"
                        >
                            {publishingAll[p.id] ? (
                      ...
                      <div key={i} className="flex flex-col md:flex-row gap-4 bg-white/5 border border-white/10 p-4 rounded-lg">
                        ...
                        <div className="flex items-center">
                            <button
                                ...
                                className={`px-4 py-2 rounded font-bold text-sm shadow-lg transition w-32 flex justify-center ${
                                    v.status === "PUBLISHED" ? "bg-gray-600 cursor-not-allowed opacity-50" :
