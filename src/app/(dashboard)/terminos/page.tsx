  ...
  return (
      ...
      <div className="max-w-4xl mx-auto bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-16 shadow-2xl">
        ...
        <div className="flex flex-col items-center justify-center mb-12 border-b border-white/10 pb-8">
            ...
            <h1 className="text-4xl font-bold text-white tracking-tight">Términos de Contenido y Uso</h1>
        ...
        <div className="space-y-12 text-lg leading-relaxed text-slate-300">
            ...
            {/* 4. Acoso y Bullying (SECCIÓN NUEVA CRÍTICA) */}
            ...
            {/* 5. Actividades Ilegales (SEPARADO) */}
            <section>
                <h2 className="text-2xl font-bold text-white mb-4">
                ...
                <p className="mt-4 text-slate-400 text-sm">
                    Reportaremos proactivamente cualquier indicio de actividad criminal a las fuerzas del orden.
                </p>
            </section>
