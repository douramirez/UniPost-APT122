...
export function encrypt(text: string): string {
  if (!ENCRYPTION_KEY) throw new Error("ENCRYPTION_KEY not found in .env");
  ...
  // Retornamos IV:TextoCifrado para poder desencriptar después
...
export function decrypt(text: string): string {
  ...
  // Si el formato no coincide (ej: tokens viejos sin encriptar), devolver null o manejar error
